...
context ('list', function ()
	...
	test ('splice', strict.wrap(function ()
		...
		assert_true (List{'a','b','c'}:splice(3,{'x','y','z'}):equal{'a','b','x','y','z','c'})
	...
	test ('__add', strict.wrap(function ()
		assert_true ((List{} + List{}):equal{})
		assert_true ((List{'a','b','c'} + List{}):equal{'a','b','c'})
		assert_true ((List{} + List{'x','y','z'}):equal{'x','y','z'})
		assert_true ((List{'a','b','c'} + List{'x','y','z'}):equal{'a','b','c','x','y','z'})
	end))

	test ('__eq', strict.wrap(function ()
		assert_true (List{} == List{})
		assert_true (List{'a'} == List{'a'})
		assert_false (List{'a'} == List{'a','b'})
		assert_false (List{'a','b'} == List{'a'})
		assert_false (List{'a','b'} == List{'a','x'})
	end))
end)
